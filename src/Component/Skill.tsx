    ...
    <div>
        <section className="skills-section bg-color-2 sec-pad">
            ...
            <div className="image-layer">
                <figure className="image image-1"><img src="assets/images/icons/wind-1.png" alt=""/></figure>
            </div>
                                ...
                                <div className="progress-inner">
                                    <div className="progress-box">
                                        <div className="bar-box">
                                            <h6>Solar Energy</h6>
                                            <div className="bar">
                                                <div className="bar-inner count-bar" data-percent="62%"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="progress-box">
                                        <div className="bar-box">
                                            <h6>Wind Energy</h6>
                                            <div className="bar">
                                                <div className="bar-inner count-bar" data-percent="89%"></div>
                                            </div>
                                        </div>
