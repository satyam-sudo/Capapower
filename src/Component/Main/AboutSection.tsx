              ...
              <div className="image_block_1">
                <div className="image-box">
                  <figure className="image image-2">
                    <img
                      src="https://cdn.dnaindia.com/sites/default/files/styles/full/public/2018/05/16/682730-inverterbattery-thinkstock-051618.jpg"
                      alt=""
                    />
                  </figure>
                  <div className="text">
                ...
                <div className="content-box">
                  ...
                  <div className="text">
                    <p>
                      ...
                      In a free hour, when our power off choice is untrammelled.
                    </p>
                  </div>
