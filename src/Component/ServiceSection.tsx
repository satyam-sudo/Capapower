         ...
         <section className="service-section sec-pad bg-color-1">
            <div className="auto-container">
                ...
                <div className="row clearfix">
                    <div className="col-lg-3 col-md-3 col-sm-4 service-block">
                        <div className="service-block-one wow fadeInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div className="inner-box pb-4">
                                <div className="inner">
                                    <div className="icon-box"><img src="https://freepngimg.com/thumb/car/3-2-car-free-download-png-thumb.png" alt="" /></div>
                                    <h5><a href="service-details.html">For Four Wheeler</a></h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-3 col-md-3 col-sm-4 service-block">
                        <div className="service-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div className="inner-box pb-4">
                                <div className="inner">
                                    <div className="icon-box"><img src="https://p.kindpng.com/picc/s/733-7330856_lorry-img-png-transparent-png.png" alt="" /></div>
                                    <h5><a href="service-details.html">For Heavy Vehicles</a></h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-3 col-md-3 col-sm-4 service-block">
                        <div className="service-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div className="inner-box pb-4">
                                <div className="inner">
                                    <div className="icon-box"><img src="https://4.imimg.com/data4/LN/OB/MY-14628236/sbs-industrial-batteries-500x500.jpg" alt="" /></div>
                                    <h5><a href="service-details.html">Industrial Batteries</a></h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-3 col-md-3 col-sm-4 service-block">
                        <div className="service-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div className="inner-box pb-4">
                                <div className="inner">
                                    <div className="icon-box"><img src="https://5.imimg.com/data5/SELLER/Default/2021/3/UQ/OW/PJ/24741173/livfast-inverter-battery-500x500.jpg" alt="" />
                                    </div>
                                    <h5><a href="service-details.html">Inverter Batteries</a></h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="sec-title centred mt-4">
                    <div className="title-text">
                        <p><a href="#" className="text-body">More to Explore</a></p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div className="row clearfix">
                    <div className="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div className="service-block-two wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div className="inner-box">
                                <figure className="image-box"><img src="https://images.squarespace-cdn.com/content/v1/5f3b08d4515c242514c95656/b44a1706-baab-41df-9e3b-7a8959c188bb/how-long-does-an-electric-car-battery-last.jpg" alt="" /></figure>
                                <div className="content-box">
                                    <div className="link"><a href="service-details.html"><i className="flaticon-right-arrow"></i><span>More</span></a></div>
                                    <div className="inner">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div className="service-block-two wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div className="inner-box">
                                <figure className="image-box"><img src="https://www.financialexpress.com/wp-content/uploads/2022/02/electric-vehicle-battery-swapping.jpeg" alt="" /></figure>
                                <div className="content-box">
                                    <div className="link"><a href="service-details.html"><i className="flaticon-right-arrow"></i><span>More</span></a></div>
                                    <div className="inner">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div className="service-block-two wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div className="inner-box">
                                <figure className="image-box"><img src="https://etimg.etb2bimg.com/thumb/msid-78868623,width-1200,resizemode-4/.jpg" alt="" /></figure>
                                <div className="content-box">
                                    <div className="link"><a href="service-details.html"><i className="flaticon-right-arrow"></i><span>More</span></a></div>
                                    <div className="inner">
